#!/bin/bash
# Train with composite medical reward (search count + MDACE evidence hit) using PPO.
...
export EXPERIMENT_NAME="medical-evidence-ppo-qwen2.5-7b-it"

export VLLM_ATTENTION_BACKEND=XFORMERS

# Reward weights
REWARD_ALPHA=0.5  # search-count weight
REWARD_BETA=0.5   # evidence-hit weight
MAX_SEARCHES=10
MAX_TURNS=10
